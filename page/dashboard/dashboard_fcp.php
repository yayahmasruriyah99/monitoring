    ...
    <div class="mb-3">
        ...
        <div class="col-md-4">
                    <select name="loop" id="loop" class="form-control">
                       <?php
                       $querySelect = pg_query($dbconn, "SELECT * FROM tbl_loop WHERE loop BETWEEN 18 AND 19");
...
<script>
    ...
    var data_cr = <?php echo json_encode($data_cr); ?>;
    ...
    Highcharts.chart('container', {
        ...
        xAxis: {
            ...
            categories: data_cr.map((_, index) => index + 1) // Menampilkan jumlah sampel sebagai nilai x
        },
