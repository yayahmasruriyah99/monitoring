...
$queryLastNacl = pg_query($dbconn,"SELECT tbl_sa_pc.*, tbl_sa_pc_detail.* FROM tbl_sa_pc, tbl_sa_pc_detail WHERE tbl_sa_pc.id=tbl_sa_pc_detail.id_sa AND tbl_sa_pc.tanggal='$tanggal_sekarang' AND tbl_sa_pc.shift='$shift' ORDER BY tbl_sa_pc_detail.sampel DESC");
