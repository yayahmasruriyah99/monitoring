                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nama_produk" name="nama_produk" required readonly>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="brand" name="brand" readonly required>
                        </div>
                        <div class="mb-3" hidden>
                            <label for="rasa">Rasa :</label>
                            <input type="text" class="form-control" id="rasa" name="rasa" required readonly>
                        </div>
...
<!-- Modal -->
  ...
  <script src="asset/https/add_pc/jquery-3.5.1.slim.min.js"></script>
  <script src="asset/https/add_pc/popper.min.js"></script>
  <script src="asset/https/add_pc/bootstrap.min.js"></script>
  <script>
